...
Correct framing: "AI agents explored 59 BPF policy programs for GPU resource management, generating code for eviction ordering, prefetch strategies, and scheduling logic — with 0 kernel panics, all safety violations contained by the eBPF verifier."
